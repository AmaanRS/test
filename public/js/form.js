...
//     professionSelect.style.display = 'none'; // Hide the dropdown
//     professionLabel.style.display = 'none'; // Hide the label
//     form2.style.display = 'block'; // Show Form2
//   }
// });


// // Add an event listener to show the dropdown when Form1 is displayed
// nextButtons.forEach(function (button) {
//   button.addEventListener('click', function () {
//     form1.style.display = 'none'; // Hide Form1
//     professionSelect.style.display = 'block'; // Show the dropdown
//   });
// });
